...
protected:
	...
	void __fastcall DrawButtonText(HDC DC, System::UnicodeString Caption, const Types::TRect &Bounds, bool Enabled, bool Hot, unsigned DrawFormat);
...
#pragma option push -b-
enum Virtualtrees__41 { hpeBackground, hpeDropMark, hpeHeaderGlyph, hpeSortGlyph, hpeText };
#pragma option pop

typedef Set<Virtualtrees__41, hpeBackground, hpeText>  THeaderPaintElements;

#pragma option push -b-
enum Virtualtrees__51 { tsCancelHintAnimation, tsChangePending, tsCheckPropagation, tsCollapsing, tsToggleFocusedSelection, tsClearPending, tsClipboardFlushing, tsCopyPending, tsCutPending, tsDrawSelPending, tsDrawSelecting, tsEditing, tsEditPending, tsExpanding, tsHint, tsInAnimation, tsIncrementalSearching, tsIncrementalSearchPending, tsIterating, tsKeyCheckPending, tsLeftButtonDown, tsLeftDblClick, tsMouseCheckPending, tsMiddleButtonDown, tsMiddleDblClick, tsNeedScale, tsNeedRootCountUpdate, tsOLEDragging, tsOLEDragPending, tsPainting, tsRightButtonDown, tsRightDblClick, tsPopupMenuShown, tsScrolling, tsScrollPending, tsSizing, tsStopValidation, tsStructureChangePending, tsSynchMode, tsThumbTracking, tsUpdateHiddenChildrenNeeded, tsUpdating, tsUseCache, tsUserDragObject, tsUseThemes, tsValidating, tsValidationNeeded, tsVCLDragging, tsVCLDragPending, tsWheelPanning, tsWheelScrolling, tsWindowCreating };
#pragma option pop

typedef Set<Virtualtrees__51, tsCancelHintAnimation, tsWindowCreating>  TVirtualTreeStates;

#pragma option push -b-
enum Virtualtrees__61 { csStopValidation, csUseCache, csValidating, csValidationNeeded };
#pragma option pop

typedef Set<Virtualtrees__61, csStopValidation, csValidationNeeded>  TChangeStates;
...
#pragma option push -b-
enum Virtualtrees__91 { suoRepaintHeader, suoRepaintScrollbars, suoScrollClientArea, suoUpdateNCArea };
#pragma option pop

typedef Set<Virtualtrees__91, suoRepaintHeader, suoUpdateNCArea>  TScrollUpdateOptions;
...
public:
	...
	System::AnsiString __fastcall ContentToText(TVSTTextSourceType Source, char Separator);
	System::UnicodeString __fastcall ContentToUnicode(TVSTTextSourceType Source, System::WideChar Separator);
	virtual void __fastcall GetTextInfo(PVirtualNode Node, TColumnIndex Column, const Graphics::TFont* AFont, Types::TRect &R, System::UnicodeString &Text);
	virtual Types::TRect __fastcall InvalidateNode(PVirtualNode Node);
...
#define DefaultPaintOptions (Set<TVTPaintOption, toHideFocusRect, toStaticBackground> () << toShowButtons << toShowDropmark << toShowRoot << toShowTreeLines << toThemeAware << toUseBlendedImages )
...
#define DefaultMiscOptions (Set<TVTMiscOption, toAcceptOLEDrop, toFullRowDrag> () << toAcceptOLEDrop << toFullRepaintOnResize << toInitOnSave << toToggleOnDblClick << toWheelPanning )
#define DefaultColumnOptions (Set<TVTColumnOption, coAllowClick, coDisableAnimatedResize> () << coAllowClick << coDraggable << coEnabled << coParentBidiMode << coParentColor << coResizable << coShowDropMark << coVisible << coAllowFocus )

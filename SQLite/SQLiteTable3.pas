...
uses
  Windows, SQLite3, Classes, SysUtils, SQLLibProcs;
...
//    constructor Create(const FileName: AnsiString);
    constructor Create(const FileName: AnsiString; DllPath: WideString);
    destructor Destroy; override;
    function GetTable(const SQL: AnsiString): TSQLiteTable;
    ...
    function GetUniTable(const SQL: AnsiString): TSQLiteUniTable;
...
constructor TSQLiteDatabase.Create(const FileName: AnsiString; DllPath: WideString);
var
  Msg: pAnsiChar;
  iResult: integer;
